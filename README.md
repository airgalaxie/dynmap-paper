...
> [!NOTE]
> **Development Environment:** Active development and compilation on **Linux** using **Java 26** and **Gradle 9.6.0**.  
...
*   **Java 26 & Gradle 9.6.0**: Cutting-edge Linux-based compilation environment for maximum performance and future-proofing.
